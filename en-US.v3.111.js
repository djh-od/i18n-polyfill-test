 ...
 * 
 * Features requested: Intl.DateTimeFormat,Intl.DateTimeFormat.~locale.en,Intl.Locale,Intl.NumberFormat,Intl.NumberFormat.~locale.en,Intl.PluralRules,Intl.PluralRules.~locale.en,Intl.getCanonicalLocales
 * 
 * - _ESAbstract.CreateMethodProperty, License: CC0 (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en", "Intl.getCanonicalLocales", "Array.prototype.sort")
 * - _ESAbstract.IsCallable, License: CC0 (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en", "Intl.getCanonicalLocales", "Array.prototype.sort")
 * - Array.prototype.sort, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en", "Intl.getCanonicalLocales")
 * - Intl.getCanonicalLocales, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en")
 * - Intl.Locale, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en")
 * - Intl.PluralRules, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en", "Intl.PluralRules.~locale.en")
 * - Intl.NumberFormat, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en")
 * - Intl.DateTimeFormat, License: MIT (required by "Intl.DateTimeFormat.~locale.en")
 * - Intl.PluralRules.~locale.en, License: MIT (required by "Intl.DateTimeFormat.~locale.en", "Intl.NumberFormat.~locale.en")
 * - Intl.NumberFormat.~locale.en, License: MIT (required by "Intl.DateTimeFormat.~locale.en")
...
(function() {
  ...
  function shouldPolyfill() {
    var p = typeof Intl === "undefined" || !("getCanonicalLocales" in Intl) || Intl.getCanonicalLocales("und-x-private")[0] === "x-private";
    console.log('[INTL] Polyfill getCanonicalLocales?', p);
    return p;
  }
...
(function() {
  ...
  function shouldPolyfill() {
    var p = typeof Intl === "undefined" || !("Locale" in Intl) || hasIntlGetCanonicalLocalesBug();
    console.log('[INTL] Polyfill Locale?', p);
    return p;
  }
...
(function() {
  ...
  function shouldPolyfill() {
    var p = typeof Intl === "undefined" || !("PluralRules" in Intl) || new Intl.PluralRules("en", {minimumFractionDigits: 2}).select(1) === "one";
    console.log('[INTL] Polyfill PluralRules?', p);
    return p;
  }
...
(function() {
  ...
  function shouldPolyfill() {
    var p = typeof Intl === "undefined" || !("NumberFormat" in Intl) || !supportsES2020() || onlySupportsEn();
    console.log('[INTL] Polyfill NumberFormat?', p);
    return p;
  }
...
(function() {
  ...
  function shouldPolyfill() {
    var p = !("DateTimeFormat" in Intl) || !("formatToParts" in Intl.DateTimeFormat.prototype) || !("formatRange" in Intl.DateTimeFormat.prototype) || hasChromeLt71Bug() || hasUnthrownDateTimeStyleBug() || !supportsDateStyle();
    console.log('[INTL] Polyfill DateTimeFormat?', p);
    return p;
  }
